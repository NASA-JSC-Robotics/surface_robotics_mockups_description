...
class TrainerManager(Node):
    def __init__(self):
        ...
        self.cabinet_1_sub = self.create_subscription(Float64, self.prefix + 'cabinet_1_position', self.cabinet_1_cb, 10)
        self.round_latch_sub = self.create_subscription(Float64, self.prefix + 'round_latch_position', self.round_latch_cb, 10)
        self.cabinet_2_sub = self.create_subscription(Float64, self.prefix + 'cabinet_2_position', self.cabinet_2_cb, 10)
        self.push_latch_button_sub = self.create_subscription(Float64, self.prefix + 'push_latch_button_position', self.push_latch_button_cb, 10)
        self.push_latch_handle_sub = self.create_subscription(Float64, self.prefix + 'push_latch_handle_position', self.push_latch_handle_cb, 10)
        self.cabinet_3_sub = self.create_subscription(Float64, self.prefix + 'cabinet_3_position', self.cabinet_3_cb, 10)
        self.cabinet_4_sub = self.create_subscription(Float64, self.prefix + 'cabinet_4_position', self.cabinet_4_cb, 10)
        self.paddle_latch_handle_sub = self.create_subscription(Float64, self.prefix + 'paddle_latch_handle_position', self.paddle_latch_handle_cb, 10)
        ...
        self.recessed_latch_handle_sub = self.create_subscription(Float64, self.prefix + 'recessed_latch_handle_position', self.recessed_latch_handle_cb, 10)
        ...
        if self.get_namespace() != "/":
            self._trainer_joint_states = {
                ...
                self.get_namespace()[1:] + "/" + self.prefix + "cabinet_1_joint": copy.deepcopy(self.cabinet_1_position),
                self.get_namespace()[1:] + "/" + self.prefix + "round_latch_joint": copy.deepcopy(self.round_latch_position),
                self.get_namespace()[1:] + "/" + self.prefix + "cabinet_2_joint": copy.deepcopy(self.cabinet_2_position),
                self.get_namespace()[1:] + "/" + self.prefix + "push_latch_button_joint": copy.deepcopy(self.push_latch_button_position),
                self.get_namespace()[1:] + "/" + self.prefix + "push_latch_handle_joint": copy.deepcopy(self.push_latch_handle_position),
                self.get_namespace()[1:] + "/" + self.prefix + "cabinet_3_joint": copy.deepcopy(self.cabinet_3_position),
                self.get_namespace()[1:] + "/" + self.prefix + "cabinet_4_joint": copy.deepcopy(self.cabinet_4_position),
                self.get_namespace()[1:] + "/" + self.prefix + "paddle_latch_handle_joint": copy.deepcopy(self.paddle_latch_handle_position),
                ...
                self.get_namespace()[1:] + "/" + self.prefix + "recessed_latch_handle_joint": copy.deepcopy(self.recessed_latch_handle_position)
            }
