...
I tried using a mesh file from a .obj file, but getting the faces and vertices right to get it to bend the way I wanted it to led me to basically recreate the grid structure in the obj.
It was easier to iterate and test using the *grid* type than to edit the mesh file every time I wanted to try something different.
